...
const styleBankOffer = TextStyle(
    fontSize: 14.0, fontWeight: FontWeight.w400, color: Color(0xffA1A1A1));

//overview specification
TextStyle headingFontSize = const TextStyle(fontSize: 20);
TextStyle commonHeadingTextFontSize = const TextStyle(
  color: Color(0xffCCCCCC),
  fontSize: 19,
  fontWeight: FontWeight.w400,
);
TextStyle commonTextFontSize =
    const TextStyle(fontSize: 19, color: Color.fromRGBO(204, 204, 204, 1));
TextStyle dropDownHeadingTextFontSize =
    const TextStyle(fontSize: 17, color: Color.fromRGBO(161, 161, 161, 1));

double relatedContentHeight = 5;
double nonRelatedContentHeight = 20;

EdgeInsets constPadding = const EdgeInsets.all(15.0);
